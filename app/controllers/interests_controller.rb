class InterestsController < ApplicationController
  ...
  # GET /interests.json
  def index
    @houseinterest = params[:type]
    @houseinterests = Interest.where(house_id:@houseinterest)
  ...
  def show
    #@interest = Interest.find(params[:house_id])
    #@interest = Interest.find(params[:type])
  end
  ...
  private
    ...
    def interest_params
      params.require(:interest).permit(:house_id, :user_id)
    end
